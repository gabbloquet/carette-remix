...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly create carette-remix-efd8
  fly create carette-remix-efd8-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app carette-remix-efd8
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app carette-remix-efd8-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'carette-remix-efd8-staging' does not match app name in config file 'carette-remix-efd8'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name carette-remix-efd8-db
  fly postgres attach --postgres-app carette-remix-efd8-db --app carette-remix-efd8

  fly postgres create --name carette-remix-efd8-staging-db
  fly postgres attach --postgres-app carette-remix-efd8-staging-db --app carette-remix-efd8-staging
  ```
